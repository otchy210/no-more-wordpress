(function() {
	...
	l.setAttribute('href', 'http://www.otchy.net/js/fancybox/jquery.fancybox-1.3.4.css');
	h.appendChild(l);
	var s1 = d.createElement("script");
	s1.setAttribute("src", "http://ajax.googleapis.com/ajax/libs/jquery/1.6/jquery.min.js");
	s1.addEventListener('load', function() {
		var s2 = d.createElement("script");
		s2.setAttribute("src", "http://www.otchy.net/js/fancybox/jquery.fancybox-1.3.4.pack.js");
