...
var TwitterAPI = {
	...
	cmd: function(cate, method, id) {
		return cate + (method && method.length > 0 ? '/' + method : '') + ( id && id.length > 0 ? '/' + id : '');
	},
	statuses: {
	...
	users: { show: function(func, id, param) { TwitterAPI.get(TwitterAPI.cmd('users', 'show', id), func, param); }
	},
	direct_messages: {
	...
	friendships: {
		create: function(func, id, param) { TwitterAPI.get(TwitterAPI.cmd('friendships', 'create', id), func); },
		destroy: function(func, id, param) { TwitterAPI.get(TwitterAPI.cmd('friendships', 'destroy', id), func); },
	...
	favourings: {
		create: function(func, id, param) { TwitterAPI.get(TwitterAPI.cmd('favourings', 'create', id), func); },
		destroy: function(func, id, param) { TwitterAPI.get(TwitterAPI.cmd('favourings', 'destroy', id), func); }
	},
	notifications: {
	...
	blocks: {
		create: function(func, id, param) { TwitterAPI.get(TwitterAPI.cmd('blocks', 'create', id)); },
		destroy: function(func, id, param) { TwitterAPI.get(TwitterAPI.cmd('blocks', 'destroy', id)); }
	},
	help: {
