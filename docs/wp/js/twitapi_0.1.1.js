...
var TwitAPI = function(base, app) {
	...
	pop.innerHTML = 
		'<div class="twit-api-js" id="twit-api-js-cont">' +
			...
			'<div class="twit-api-js" id="twit-api-js-div2">「認証」ボタンを押して、Twitter の OAuth 認証画面を開いて下さい。</div>' +
			'<div class="twit-api-js" id="twit-api-js-div3"><button id="twit-api-js-auth">認証</button></div>' +
			'<div class="twit-api-js" id="twit-api-js-div4">認証を許可して「認証 OK」と表示されたら「継続」ボタンを押して下さい。</div>' +
			'<div class="twit-api-js" id="twit-api-js-div5"><button id="twit-api-js-continue">継続</button></div>' +
		'</div>';
	this.ac(pop);
	...
	this._call = function(method, path, func, params) {
		...
		var src = api.base + '/' + method + '/' + api.app + '/';
		if (!!path) {
			src += path;
		}
		src += '?callback=' + fn;
